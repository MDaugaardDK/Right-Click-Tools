...
Get-ChildItem -Path ".\" -Recurse -File -Include "*.msi" | Get-MsiInformation | Out-GridView -Wait
...
#Get-ChildItem -Path ".\" -Recurse -File -Include "*.msi" | Get-MsiInformation | Out-File .\MsiOutput.txt -Force
Get-ChildItem -Path ".\" -Recurse -File -Include "*.msi" | Get-MsiInformation | Out-GridView -Wait